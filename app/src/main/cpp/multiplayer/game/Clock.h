...
//    static uint8& CurrentDay;
    static inline uint16    ms_nGameClockSeconds;
    static inline uint8     ms_nGameClockMinutes;
    static inline uint8     ms_nGameClockHours;
    static inline uint8     ms_nGameClockDays;
