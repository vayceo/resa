...
VALIDATE_SIZE(CStoredShadow_VC, 0x30);
...
VALIDATE_SIZE(CStaticShadow_VC, 0x40);

class CPermanentShadow_VC
{
public:
	CVector m_vecPos;
	CVector2D m_vecFront;
...
VALIDATE_SIZE(CPermanentShadow_VC, 0x38);

class CShadows_VC
{
public:
	static int16                ShadowsStoredToBeRendered;
	static CStoredShadow_VC     asShadowsStored  [MAX_STOREDSHADOWS];
	static CPolyBunch           aPolyBunches     [MAX_POLYBUNCHES];
	static CStaticShadow_VC     aStaticShadows   [MAX_STATICSHADOWS];
	static CPolyBunch           *pEmptyBunchList;
	static CPermanentShadow_VC  aPermanentShadows[MAX_PERMAMENTSHADOWS];
	...
	static void CalCPedGtaShadowValues            (CVector vecLightDir, float *pfFrontX, float *pfFrontY, float *pfSideX, float *pfSideY, float *pfDisplacementX, float *pfDisplacementY);
