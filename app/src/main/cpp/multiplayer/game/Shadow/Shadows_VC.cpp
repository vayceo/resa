...
//RwTexture *gpGoalTex;
//
//int16               CShadows_VC::ShadowsStoredToBeRendered;
//CStoredShadow_VC    CShadows_VC::asShadowsStored  [MAX_STOREDSHADOWS];
//CPolyBunch          CShadows_VC::aPolyBunches     [MAX_POLYBUNCHES];
//CStaticShadow_VC    CShadows_VC::aStaticShadows   [MAX_STATICSHADOWS];
//CPolyBunch          *CShadows_VC::pEmptyBunchList;
//CPermanentShadow_VC CShadows_VC::aPermanentShadows[MAX_PERMAMENTSHADOWS];
//
//#ifndef MASTER
...
//
//void
//CShadows_VC::AddPermanentShadow(uint8 ShadowType, RwTexture *pTexture, CVector *pPosn,
...
//		aPermanentShadows[nSlot].m_nTimeCreated = CTimer::GetTimeInMS();
//	}
//}
//
//bool
//CShadows_VC::StoreStaticShadow(uint32 nID, uint8 ShadowType, RwTexture *pTexture, Const CVector *pPosn,
//							float fFrontX, float fFrontY, float fSideX, float fSideY,
//							int16 nIntensity, uint8 nRed, uint8 nGreen, uint8 nBlue,
...
//				aStaticShadows[nSlot].m_nTimeCreated     = CTimer::GetTimeInMS();
//
//				return true;
//			}
...
//
//void
//CShadows_VC::StoreShadowToBeRendered(uint8 ShadowTexture, CVector *pPosn,
//								float fFrontX, float fFrontY, float fSideX, float fSideY,
//								int16 nIntensity, uint8 nRed, uint8 nGreen, uint8 nBlue)
//{
//	ASSERT(pPosn != nil);
...
//
//void
//CShadows_VC::StoreShadowToBeRendered(uint8 ShadowType, RwTexture *pTexture, CVector *pPosn,
//								float fFrontX, float fFrontY, float fSideX, float fSideY,
//								int16 nIntensity, uint8 nRed, uint8 nGreen, uint8 nBlue,
...
//			}
//
//			CarPos.x -= pCar->GetForward().x * (((fVehicleHeight/2) - pCar->GetColModel()->m_boundBox.m_vecMax.y)*size);
//			CarPos.y -= pCar->GetForward().y * (((fVehicleHeight/2) - pCar->GetColModel()->m_boundBox.m_vecMax.y)*size);
//
...
//			}
//
//			if ( pCar->m_vecMoveSpeed.Magnitude() * CTimer::ms_fTimeStep > 0.1f || bDrawOnBuildings )
//			{
...
//			}
//
//			if ( pCar->m_vecMoveSpeed.Magnitude() * CTimer::ms_fTimeStep > 0.4f || pCar == FindPlayerVehicle() )
//			{
...
//			at.Normalise();
//
//			CShadows_VC::CalCPedGtaShadowValues(at, &fFrontX, &fFrontY, &fSideX, &fSideY, &fDisplacementX, &fDisplacementY);
//
//			pos.x -= 2.5f * fDisplacementX;
//			pos.y -= 2.5f * fDisplacementY;
//
//			CShadows_VC::StoreShadowToBeRendered(SHADOWTYPE_INVCOLOR, texture, &pos,
...
//
//void
//CShadows_VC::StoreShadowForPedObject(CEntity *pPedObject, float fDisplacementX, float fDisplacementY,
//								float fFrontX, float fFrontY, float fSideX, float fSideY)
//{
...
//
//void
//CShadows_VC::StoreShadowForCutscenePedObject(CCutsceneObject *pObject, float fDisplacementX, float fDisplacementY,
//								float fFrontX, float fFrontY, float fSideX, float fSideY)
//{
...
//			at.Normalise();
//
//			CalCPedGtaShadowValues(at, &fFrontX, &fFrontY, &fSideX, &fSideY, &fDisplacementX, &fDisplacementY);
//
//			pos.x -= 2.5f * fDisplacementX;
//			pos.y -= 2.5f * fDisplacementY;
//
...
//
//void
//CShadows_VC::StoreShadowForTree(CEntity *pTree)
//{
//	ASSERT(pTree != nil);
//}
//
//
//void
//CShadows_VC::StoreShadowForPole(CEntity *pPole, float fOffsetX, float fOffsetY, float fOffsetZ,
...
//
//void
//CShadows_VC::SetRenderModeForShadowType(uint8 ShadowType)
//{
//	switch ( ShadowType )
//	{
...
//
//void
//CShadows_VC::RenderStoredShadows(void)
//{
//	//PUSH_RENDERGROUP("CShadows_VC::RenderStoredShadows");
...
//
//					int32 nStartX = std::max(CWorld::GetSectorIndexX(fStartX), 0);
//					int32 nStartY = std::max(CWorld::GetSectorIndexY(fStartY), 0);
//					int32 nEndX   = std::min(CWorld::GetSectorIndexX(fEndX), NUMSECTORS_X-1);
//					int32 nEndY   = std::min(CWorld::GetSectorIndexY(fEndY), NUMSECTORS_Y-1);
//
...
//
//void
//CShadows_VC::RenderStaticShadows(void)
//{
//	//PUSH_RENDERGROUP("CShadows_VC::RenderStaticShadows");
//
//	RenderBuffer::ClearRenderBuffer();
//
//	RwRenderStateSet(rwRENDERSTATEZWRITEENABLE,      (void *)FALSE);
...
//
//void
//CShadows_VC::GeneratePolysForStaticShadow(int16 nStaticShadowID)
//{
...
//
//void
//CShadows_VC::CastShadowSectorList(CPtrList &PtrList, float fStartX, float fStartY, float fEndX, float fEndY, CVector *pPosn,
//								float fFrontX, float fFrontY, float fSideX, float fSideY,
//								int16 nIntensity, uint8 nRed, uint8 nGreen, uint8 nBlue,
...
//
//void
//CShadows_VC::CastPlayerShadowSectorList(CPtrList &PtrList, float fStartX, float fStartY, float fEndX, float fEndY, CVector *pPosn,
//								float fFrontX, float fFrontY, float fSideX, float fSideY,
//								int16 nIntensity, uint8 nRed, uint8 nGreen, uint8 nBlue,
//								float fZDistance, float fScale, CPolyBunch **ppPolyBunch)
//{
...
//
//void
//CShadows_VC::CastCutsceneShadowSectorList(CPtrList &PtrList, float fStartX, float fStartY, float fEndX, float fEndY, CVector *pPosn,
//								float fFrontX, float fFrontY, float fSideX, float fSideY,
//								int16 nIntensity, uint8 nRed, uint8 nGreen, uint8 nBlue,
...
//
//void
//CShadows_VC::CastShadowEntityXY(CEntity *pEntity,  float fStartX, float fStartY, float fEndX, float fEndY, CVector *pPosn,
//							float fFrontX, float fFrontY, float fSideX, float fSideY,
//							int16 nIntensity, uint8 nRed, uint8 nGreen, uint8 nBlue,
//							float fZDistance, float fScale, CPolyBunch **ppPolyBunch)
//{
...
//
//void
//CShadows_VC::CastShadowEntityXYZ(CEntity *pEntity, CVector *pPosn,
//								float fFrontX, float fFrontY, float fSideX, float fSideY,
//								int16 nIntensity, uint8 nRed, uint8 nGreen, uint8 nBlue,
//								float fZDistance, float fScale, CPolyBunch **ppPolyBunch, CCutsceneShadow *pShadow)
//{
...
//
//void
//CShadows_VC::UpdateStaticShadows(void)
//{
//	for ( int32 i = 0; i < MAX_STATICSHADOWS; i++ )
//	{
//		if ( aStaticShadows[i].m_pPolyBunch != nil && !aStaticShadows[i].m_bJustCreated
//			&& (!aStaticShadows[i].m_bTemp || CTimer::GetTimeInMS() > aStaticShadows[i].m_nTimeCreated + 5000) )
//		{
...
//
//void
//CShadows_VC::UpdatePermanentShadows(void)
//{
//	for ( int32 i = 0; i < MAX_PERMAMENTSHADOWS; i++ )
//	{
//		if ( aPermanentShadows[i].m_nType != SHADOWTYPE_NONE )
//		{
//			uint32 timePassed = CTimer::GetTimeInMS() - aPermanentShadows[i].m_nTimeCreated;
//
...
//
//void
//CStaticShadow_VC::Free(void)
//{
//	if ( m_pPolyBunch != nil )
//	{
//		CPolyBunch *pFree = CShadows_VC::pEmptyBunchList;
//		CShadows_VC::pEmptyBunchList = m_pPolyBunch;
//
...
//
//void
//CShadows_VC::CalCPedGtaShadowValues(CVector vecLightDir,
...
//
//void
//CShadows_VC::RenderExtraPlayerShadows(void)
//{
//#ifdef FIX_BUGS
...
//
//void
//CShadows_VC::TidyUpShadows(void)
//{
//	for ( int32 i = 0; i < MAX_PERMAMENTSHADOWS; i++ )
//		aPermanentShadows[i].m_nType = SHADOWTYPE_NONE;
//}
//
//void
//CShadows_VC::RenderIndicatorShadow(uint32 nID, uint8 ShadowType, RwTexture *pTexture,  CVector *pPosn,
//								float fFrontX, float fFrontY, float fSideX, float fSideY,
//								int16 nIntensity)
//{
//	ASSERT(pPosn != nil);
